...
const MOCK_LOST_ITEMS: LostItem[] = [
  ...
  },
  {
    ...
    tuyen_xe: "TP.HCM đến Nha Trang",
    ngay_di_chuyen: "2026-07-02",
    vi_tri_ghe: "Ghế số 2",
    mo_ta_vat_pham: "Kính mắt thời trang gọng kim loại mạ vàng, tròng kính đen nhạt, đựng trong bao da màu nâu hiệu Gentle Monster",
